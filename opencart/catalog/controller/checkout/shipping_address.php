...
class ControllerCheckoutShippingAddress extends Controller {
	public function index() {
        ...
        $data['text_address_new_NP'] = $this->language->get('text_address_new_NP');
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode(array (
            ...
            "apiKey" => "15e00c39c9842032c3f0f7977d1cb678"
...
//echo "<pre/>";
        ...
        $i = 0;
        foreach ($str->data as $dataTemp) {
            global $data1;
            $dataCity[$i] = $dataTemp->DescriptionRu;
            $dataRef[$i] = $dataTemp->Ref;
            $i++;
        }
        $data['cities'] = $dataCity;
        $data['refs'] = $dataRef;
        $data['text_choose_city_NP'] = $this->language->get('text_choose_city_NP');
        $data['text_choose_city_NP_dep'] = $this->language->get('text_choose_city_NP_dep');
	...
	public function save() {
		...
		$json = array();
       // echo "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF";
